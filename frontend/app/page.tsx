...
const TOOLS: ToolCard[] = [
  ...
  {
    href: "/codesign", accent: "var(--blue-bright)", iconBg: "var(--blue-glow)", tag: "Live",
    name: "Code Signing",
    desc: "Recursively discover signable files in a release directory and sign them — native OS signers (Authenticode/codesign/gpg/jarsigner) when available, a generic Ed25519 detached signature otherwise. Produces a signed manifest.",
    chips: ["Directory scan", "Ed25519/RSA-PSS", "Native signers", "CBOM"],
    available: true,
  ...
  {
    href: "/pwhash", accent: "var(--cyan-bright)", iconBg: "var(--cyan-glow)", tag: "Live",
    name: "Password Hashing",
    desc: "Classify password hash strength across Linux /etc/shadow, Windows LM/NTLM dumps, and Cisco IOS configs. Flags weak/legacy schemes and gives per-platform hardening commands to roll the algorithm forward.",
    chips: ["Linux/macOS/Windows", "Cisco IOS", "yescrypt/argon2", "Hardening plans"],
    available: true,
    iconPath: <path d="M4 9h16M4 15h16M10 3L8 21M16 3l-2 18" />,
  },
  {
    href: "#", accent: "var(--slate)", iconBg: "var(--slate-glow)", tag: "Coming soon",
    name: "VPN Discovery",
