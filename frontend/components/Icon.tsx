type IconName =
  ...
  | "execute" | "tools" | "back" | "sign" | "verify" | "hash" | "workflow";
...
const PATHS: Record<IconName, JSX.Element> = {
  ...
  sign: <><ellipse cx="12" cy="5" rx="9" ry="3" /><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3" /><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5" /></>,
  verify: <><path d="M9 12l2 2 4-4" /><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></>,
  hash: <path d="M4 9h16M4 15h16M10 3L8 21M16 3l-2 18" />,
  workflow: <><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /><path d="M10 6.5h4M17.5 10v4" /></>,
};
